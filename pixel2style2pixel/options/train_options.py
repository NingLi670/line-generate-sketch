...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--checkpoint_path_encoder', default=None, type=str, help='Path to pSp model checkpoint')
		self.parser.add_argument('--checkpoint_path_decoder', default=None, type=str,
								 help='Path to pSp model checkpoint')
